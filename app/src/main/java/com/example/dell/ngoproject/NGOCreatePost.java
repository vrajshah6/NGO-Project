...
public class NGOCreatePost extends AppCompatActivity implements View.OnClickListener {
    ImageView createPost;
    TextView tvNGOName;
    MaterialEditText edtPostTitle, edtPostDesc, edtAmount;
    Button btnUpload;
    Uri photoUri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ngocreate_post);
    ...
    private void uploadImage() {
        ...
        if(photoUri!=null)
        {
            ...
            final StorageReference imagesRef = storageRef.child("fundraise").child(imageName);
          ...
          //  final StorageReference imagesRef = storageRef.child("fundraise");
            ...
            Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public Task<Uri> then(@NonNull Task<UploadTask.TaskSnapshot> task) throws Exception {
                    ...
                    uploadPost(getString(R.string.fund_raise_image_url, "%2F", imageName));
    ...
    private void uploadPost(String photoUrl) {
        ...
        params.put("title", RequestBody.create(MediaType.parse("text/plain"), edtPostTitle.getText().toString()));
        params.put("desc", RequestBody.create(MediaType.parse("text/plain"), edtPostDesc.getText().toString()));
        params.put("amt", RequestBody.create(MediaType.parse("text/plain"), edtAmount.getText().toString()));
        params.put("date", RequestBody.create(MediaType.parse("text/plain"), "12/12/2019"));
        params.put("n_id", RequestBody.create(MediaType.parse("text/plain"), "202"));
...
//        }
        ...
        Call<Map<String,Object>> call = api.uploadFundRaisingPost(params);
